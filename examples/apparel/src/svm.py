...
if __name__ == '__main__':
    ...
    #test_view1_data = loadFeatures(features_filename = './data/features.txt', labels_filename = './data/test.txt')
    #test_view2_data = loadFeatures(features_filename = './data/features_noisy.txt', labels_filename = './data/test_noisy.txt')
    test_view1_data = (np.load(sys.argv[1] + 'view1.npy')[:10000], np.load(sys.argv[1] + 'labels.npy').flatten()[:10000])
    test_view2_data = (np.load(sys.argv[1] + 'view2.npy')[:10000], np.load(sys.argv[1] + 'labels.npy').flatten()[:10000])
